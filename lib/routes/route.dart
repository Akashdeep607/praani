...
import '../screens/appointments/doctor_appointment_view.dart';
import '../screens/appointments/my_appointments_view.dart';
...
class Routes {
  ...
  static final Map<String, WidgetBuilder> _routes = {
    ...
    RouteList.myAnimals: (context) {
      return const MyAnimalsScreen();
    },
    RouteList.appointments: (context) {
    ...
    RouteList.multiSiteSelection: (context) => MultiSiteFactory.instance.multiSiteSelectionScreen(context),
  ...
  static Route getRouteGenerate(RouteSettings settings) {
    ...
    switch (routingData.route) {
        ...
        if (arguments is BackDropArguments) {
          ...
          if (isWordpressBlog) {
            ...
            return _buildRoute(routeSetting, (context) {
              ...
              final config = arguments.config;
              final blogConfig = config != null ? BlogConfig.fromJson(config) : BlogConfig.empty();
          ...
          // Woo
          final routeSetting = RouteSettings(name: RouteList.products, arguments: settings.arguments);
          ...
          return _buildRoute(routeSetting, (context) {
            ...
            final allowFilterMultipleCategory = arguments.allowFilterMultipleCategory;
            final categoryMenuStyle = arguments.categoryMenuStyle;
            final categoryMenuShowDepth = arguments.categoryMenuShowDepth;
            final brandIds = (arguments.brandId?.isNotEmpty ?? false) ? [arguments.brandId!] : null;

            try {
              var configValue = config != null ? ProductConfig.fromJson(config) : ProductConfig.empty();

              var categoryId = cateId?.split(',') ?? configValue.category;
              categoryId?.removeWhere((element) => element.isEmpty || element == kEmptyCategoryID);
              ...
              if (kIsWeb || (Layout.isDisplayDesktop(context) && !Layout.isDisplayTablet(context))) {
              ...
              if (categoryId != null || brandIds != null || listingLocationId != null || tagId != null) {
                productModel.fetchProductsByCategory(
                  categoryId: firstBuild ? categoryId : productModel.categoryIds,
                  brandIds: firstBuild ? brandIds : productModel.brandIds,
                  categoryName: firstBuild ? categoryName : productModel.categoryName,
              ...
              if (animationConfig != null && animationConfig is Map) {
                animatedConfig = AnimatedItemListConfig.tryParse(animationConfig);
              }
              ...
              var productConfig = configValue
                ...
                ..tag = tagId
                ..name = configValue.onSale && showCountdown ? categoryName : null
                ..showCountDown = configValue.showCountDown && configValue.onSale && showCountdown;
        ...
        if (data is TabBarMenuConfig) {
          return _buildRoute(
            ...
            (_) => CategoriesScreen(
              ...
              parallaxImageRatio: Tools.formatDouble(data.jsonData['parallaxImageRatio']),
            ),
          );
        }
        return _buildRoute(
          ...
          return _buildRoute(
            ...
            (context) {
              return ChangeNotifierProvider<ListOrderHistoryModel>(
                ...
                child: Layout.isDisplayDesktop(context) ? WebListOrderHistoryScreen() : ListOrderHistoryScreen(),
              );
            },
          );
        }
      ...
      case RouteList.static:
        ...
        if (data is TabBarMenuConfig) {
          return _buildRoute(
            settings,
            (_) => StaticPage(
              data: data.jsonData['data'] != null ? Map<String, dynamic>.from(data.jsonData['data']) : null,
            ),
          );
        }
        return _errorRoute();
      ...
      case RouteList.vendorAdmin:
        final data = settings.arguments;
        if (data is User) {
          return _buildRoute(settings, (context) => Services().widget.renderVendorAdmin(context, data));
        }
        return _errorRoute();
      case RouteList.delivery:
        final data = settings.arguments;
        if (data is User) {
          return _buildRoute(settings, (context) => Services().widget.renderDelivery(context, data));
        }
        return _errorRoute();
      case RouteList.dynamic:
        ...
        if (data is TabBarMenuConfig) {
          return _buildRoute(
            settings,
            (context) => DynamicScreen(configs: data.jsonData['configs'], previewKey: data.key),
          );
        }
      ...
      case RouteList.home:
        ...
        final controller = argument is TabBarMenuConfig ? argument.scrollController : null;
        ...
        return _buildRoute(
          ...
          (context) => ChangeNotifierProvider<FilterBrandModel>(
            ...
            child: ProductsScreen(
              ...
              categoryMenuShowDepth: bool.tryParse('${argument?['categoryMenuShowDepth']}') ?? false,
              allowFilterMultipleCategory: bool.tryParse('${argument?['allowFilterMultipleCategory']}'),
            ),
          ),
        );
      ...
      case RouteList.subCategories:
        ...
        if (arguments is SubcategoryArguments) {
          final subcategoryModel = SubcategoryModel(parentId: arguments.parentId)..getData();
          return _buildRoute(
            settings,
            (context) => ChangeNotifierProvider.value(
              ...
              child: ChangeNotifierProvider.value(
                ...
                child: SubcategoryScreen(
                  ...
                  allowFilterMultipleCategory: arguments.allowFilterMultipleCategory,
      ...
      case RouteList.updateUser:
        return _buildRoute(settings, (context) => Services().widget.renderUpdateProfileScreen());
      ...
      case RouteList.videos:
        ...
        if (data is TabBarMenuConfig) {
          styleVersions = data.jsonData['styleVersions'] is List
              ? (data.jsonData['styleVersions'] as List).map((e) => e.toString()).toList()
              : styleVersions;
        }
        return _buildRoute(
          settings,
      ...
      case RouteList.selectAddress:
        ...
        return _buildRoute(settings, (context) => ChooseAddressScreen(arguments));
  ...
  static Route _buildRoute(RouteSettings settings, WidgetBuilder builder, {bool fullscreenDialog = false}) {
    if (kIsWeb || isDesktop || (UniversalPlatform.isAndroid == false && UniversalPlatform.isIOS == false)) {
      return _buildRouteFade(
        settings,
        builder,
      );
