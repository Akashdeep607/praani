...
Map<String, dynamic> environment = {
  ...
  "serverConfig": {
    ...
    'url': 'https://praanisakha.com/', 
    // 'url': 'https://agratix.com/psdemo/',
    'type': 'woo',
    'consumerKey': 'ck_c4ae20c9ebd9583f33c186d40956aa63993427c6', //prod
    'consumerSecret': 'cs_6b31bb565158acc926c7978e7e8c7eb3bc177597', // prod
    // 'consumerKey': 'ck_30ef778ea9f4ae654032a399419900756a733e60',
    // 'consumerSecret': 'cs_eed629a9ca2a7a5964bcec3897b0db33cf7e446e',
  ...
  "phoneNumberConfig": {
    ...
    "selectorFlagAsPrefixIcon": false,
  ...
  "advanceConfig": {
    ...
    "PrivacyPoliciesPageUrlOrId": "https://praanisakha.com/privacy-policy.html",

    "SupportPageUrl": "https://support.inspireui.com/",

    "DownloadPageUrl": 'https://fluxstore.app/',

    "AboutUSPageUrl": "https://praanisakha.com/about-us.html",
  ...
  "defaultDrawer": {
    ...
    "items": [
      ...
      {"type": "cart", "show": true},
      {"type": "my animals", "show": true},
      {"type": "appointments", "show": true},
      {"type": "health records", "show": true},
  ...
  "wishListConfig": {
    ...
    /// only support wishlish type normal
    "showCartButton": true,
  },
  "defaultSettings": [
    "vendorAdmin",
  ...
  "languagesInfo": [
    ...
    {"name": "Telugu", "icon": "assets/images/country/in.png", "code": "te", "text": "తెలుగు", "storeViewCode": ""},
    // 59 Amharic - intl_am.arb
    {"name": "Amharic", "icon": "assets/images/country/am.png", "code": "am", "text": "አማርኛ", "storeViewCode": ""}
  ],
  ...
  "tapConfig": {"SecretKey": "sk_test_XKokBfNWv6FIYuTMg5sLPjhJ", "paymentMethodId": "tap", "enabled": false},
  "mercadoPagoConfig": {
  ...
  "payTmConfig": {"paymentMethodId": "paytm", "merchantId": "your-merchant-id", "production": false, "enabled": false},
  "payStackConfig": {
  ...
  "thaiPromptPayConfig": {'paymentMethodId': 'thai-promptpay-easy', 'enabled': false},
  "fibConfig": {
    'paymentMethodId': 'fib',
  ...
  "afterShip": {
    ...
    "custom_tracking_url": "https://fluxstore.aftership.com/{slug}/{trackingNumber}",
  },

  /// Ref: https://support.inspireui.com/help-center/articles/3/25/16/google-map-address
  "googleApiKey": {
    'android': 'AIzaSyDidx8X8CZZno_c2NdnmNnJHQrTbT49T9A',
    'ios': 'AIzaSyDidx8X8CZZno_c2NdnmNnJHQrTbT49T9A',
    'web': 'AIzaSyDidx8X8CZZno_c2NdnmNnJHQrTbT49T9A'
  },
