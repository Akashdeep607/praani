...
class _SMSIndexState extends State<SMSIndex> {
  ...
  Future<void> createAndLogin(data) async {
    print('SMS_LOGIN - createAndLogin');
    final model = Provider.of<SMSModel>(context, listen: false);
    try {
